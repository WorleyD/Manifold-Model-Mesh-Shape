...
class mesh:
    ...
    def __init__(self):
        ...
        # Store the vector that translated each triangle so v0 was at the origin (so we can retrieve the original triangle later) 
        self.translation = []
        # Stores the rotation matrices that put each triangle in canonical form
        self.rot = []
        # Stores the Canonical form for each triangle
        self.canonical = []
        #Store A for each triangle such that it maps the canonical triangle to the templates corresponding canonical triangle
        self.ga = []
        #Store S for each triangle for optional scaling
        self.scale = []
        # Vertex normals
